...
<div class="try-it">
<h2>Try It: Least favorite books</h2>

<p>Modify the example program to print out your least favorite books</p>

<pre>Home for a Bunny is one of my least favorite books.
Great Expectations is one of my least favorite books.
...etc
</pre>

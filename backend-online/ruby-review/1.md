...
Look at the contrived program below. Using what you learned from the prework, share one or more statements about the code. Feel free to use vocabulary such as variable, string, integer, reassigned, underscore, method, snake case, etc.

Example: <b>The variable favorite_season contains a string.</b>
...
<div class="try-it-new">
  ...
  <ul>
    ...
    <li><a href="https://repl.it/@turingschool/Politician-Speech" target="blank">Political Speech</a></li>
